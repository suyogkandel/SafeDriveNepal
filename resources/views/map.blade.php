...
map.on('click',function(e) {
    ...
    // second location is from the click
        ...
        e.routes[0].coordinates.forEach(function(coord, index){
            ...
            }, 750 * index); // every 100 millisec times index change the marker|
        })
    })
...
//marker
var marker = L.marker([27.66882, 84.43168],{icon: busIcon2}).addTo(map);
...
map.on('click',function(e) {
    ...
    // second location is from the click
                // L.latLng(e.latlng.lat, e.latlng.lng)
                // L.latLng(27.67056, 84.43370)
                L.latLng(27.671119517468338, 84.43552127072529)
        ...
        e.routes[0].coordinates.forEach(function(coord, index){
            setTimeout(() => {
                // console.log("HERE",coord.lat, coord.lng)
                marker.setLatLng([coord.lat, coord.lng])
            }, 680 * index); // every 100 millisec times index change the marker|
        })
    })
